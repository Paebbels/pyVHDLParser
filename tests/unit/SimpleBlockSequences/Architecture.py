...
from pyVHDLParser.Token             import StartOfDocumentToken, WordToken, WhitespaceToken, CharacterToken, EndOfDocumentToken, LinebreakToken, IndentationToken, MultiLineCommentToken, SingleLineCommentToken
from pyVHDLParser.Blocks            import StartOfDocumentBlock, EndOfDocumentBlock, CommentBlock
from pyVHDLParser.Blocks.Whitespace     import WhitespaceBlock, IndentationBlock, LinebreakBlock
