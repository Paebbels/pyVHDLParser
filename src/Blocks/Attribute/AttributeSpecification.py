...
from src.Blocks.Common        import LinebreakBlock, WhitespaceBlock
...
class AttributeSpecificationBlock(Block):
	def RegisterStates(self):
		return [
			self.stateAttributeSpecificationKeyword,
			self.stateWhitespace1,
			self.stateAttributeSpecificationName,
	...
	@classmethod
	def stateAttributeSpecificationKeyword(cls, parserState):
	...
	@classmethod
	def stateAttributeSpecificationName(cls, parserState):
		token = parserState.Token
