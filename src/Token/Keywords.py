...
class AndKeyword(KeywordToken):           __KEYWORD__ = "and"
...
class NandKeyword(KeywordToken):          __KEYWORD__ = "nand"
class NewKeyword(KeywordToken):           __KEYWORD__ = "new"
class NextKeyword(KeywordToken):          __KEYWORD__ = "next"
class NorKeyword(KeywordToken):           __KEYWORD__ = "nor"
...
class OrKeyword(KeywordToken):            __KEYWORD__ = "or"
...
class RolKeyword(KeywordToken):           __KEYWORD__ = "rol"
class RorKeyword(KeywordToken):           __KEYWORD__ = "ror"
...
class SlaKeyword(KeywordToken):           __KEYWORD__ = "sla"
class SllKeyword(KeywordToken):           __KEYWORD__ = "sll"
class SraKeyword(KeywordToken):           __KEYWORD__ = "sra"
class SrlKeyword(KeywordToken):           __KEYWORD__ = "srl"
...
class XorKeyword(KeywordToken):           __KEYWORD__ = "xor"
class XnorKeyword(KeywordToken):          __KEYWORD__ = "xnor"
