...
from pyVHDLParser.Token                     import CharacterToken, WhitespaceToken, LinebreakToken, CommentToken, IndentationToken, MultiLineCommentToken, SingleLineCommentToken
