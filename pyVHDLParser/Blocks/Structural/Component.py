...
class NameBlock(Block):
	...
	def stateComponentKeyword(cls, parserState: ParserState):
		...
		raise TokenParserException("Expected whitespace after keyword COMPONENT.", token)
	...
	def stateWhitespace1(cls, parserState: ParserState):
		...
		raise TokenParserException("Expected component name (identifier).", token)
	...
	def stateComponentName(cls, parserState: ParserState):
		...
		raise TokenParserException("Expected whitespace after component name.", token)
