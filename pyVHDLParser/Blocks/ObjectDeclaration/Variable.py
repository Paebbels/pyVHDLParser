...
#
# load dependencies
from pyVHDLParser.Token                import CommentToken, SpaceToken, LinebreakToken, StringToken, MultiLineCommentToken, CharacterToken, FusedCharacterToken
...
class VariableBlock(Block):
	...
	def stateWhitespace1(cls, parserState: ParserState):
		...
		raise TokenParserException("Expected variable name (identifier).", token)
	...
	def stateVariableName(cls, parserState: ParserState):
		...
		raise TokenParserException("Expected ':' or whitespace after variable name.", token)
	...
	def stateWhitespace2(cls, parserState: ParserState):
		...
		raise TokenParserException("Expected colon after variable name.", token)
